...
const ManageVideos = () => {
  ...
  return (
    <div className="min-h-screen text-[#22201F]">
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {allTags.map((tag) => (
          <button
            ...
            className="text-xs bg-gray-100 hover:bg-yellow px-2 py-1 rounded"
          >
            #{tag}
          </button>
        ))}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredVideos.map((video) => (
          <div
            key={video.id}
            className="bg-white p-4 border border-gray-200 rounded shadow-sm flex flex-col justify-between h-[430px]"
          >
            {video.thumbnail && (
              <img
                src={video.thumbnail}
            ...
            <div className="flex items-center justify-between mt-auto pt-3 border-t">
              ...
              <button
                ...
                className={`text-sm ${video.pinned ? "text-yellow" : "text-gray-400"}`}
              >
                <FaThumbtack />
              </button>
            </div>
