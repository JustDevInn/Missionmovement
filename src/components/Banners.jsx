  ...
  return (
    <div>
      {[
        ...
        <section key={index} className="relative h-[500px] w-screen my-10">
          {/* Background Image */}
          ...
          {/* Content */}
          <div className="relative z-10 h-full flex flex-col justify-center items-start text-left px-10 lg:px-20 text-white ">
