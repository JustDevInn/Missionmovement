...
const Home = () => {
      ...
      <section className="section flex justify-center items-center bg-royalmarine bg-bottom bg-no-repeat bg-cover relative">
        ...
        <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-center px-5 lg:px-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 mt-6">
            ...
            <Link to="/program">
              <button
                className="btn py-4 px-8 h-[60px] min-w-[200px] flex items-center justify-center uppercase font-bold tracking-widest bg-yellow text-black 
      ...
      <section className="">
        ...
        <div className="lg:h-[500px] w-screen flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 px-10 lg:px-20 py-20 flex flex-col justify-center items-start text-left">
            ...
            <p className="text-white text-lg font-thin tracking-wider text-justify">
              Experience an immersive journey toward elite forces. <br></br>Our
              6-week coaching program covers every facet, from physical fitness
              to mental resilience. Step into a rigorous curriculum tailored to
              equip you with the skills and mindset for success.
            </p>
          </div>
        </div>
        {/* success stories */}
  ...
  ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}
          ...
          <p className="text-white font-light tracking-wider md:text-[20px] text-center">
            Begin your path to the elite.<br></br>
            <br></br>
            Join Mission Movement's program and embark on a transformative
            journey.<br></br> Dare to achieve greatness.
          </p>
          <Link to="/program">
