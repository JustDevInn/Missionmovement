const mariniersConfig = {
  ...
  hero: {
    ...
    imageAlt: "Spelioladder Mariniers",
  ...
  intro: {
    emblemSrc: "/img/eenheden/kmarns_embleem.svg",
    ...
    items: [
      {
        ...
        image: "/img/korpsmariniers/chatham.jpg",
        objectPosition: "bottom",
        content:
      ...
      },
      {
        ...
        image: "/img/korpsmariniers/internationalepartners.webp",
      ...
      {
        title: "Fysieke Eisen",
        image: "/img/korpsmariniers/selectie.jpg",
        objectPosition: "top",
        content:
      ...
      },
      {
        ...
        image: "/img/korpsmariniers/opleidingbarret.jpg",
        objectPosition: "center",
  ...
  De EMV Marns is één van de zwaarste opleidingen binnen Defensie. Wie onvoorbereid begint, haakt af. Wie doelgericht toewerkt, wordt gevormd tot marinier.`,
      },
      {
        ...
        image: "/img/korpsmariniers/specialisaties.jpg",
        objectPosition: "center",
  ...
  contentBlocks: [
    {
      heading: "Special Forces binnen het Korps Mariniers",
      items: [
        {
...
export default mariniersConfig;
