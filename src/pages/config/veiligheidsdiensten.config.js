const veiligheidsdienstenConfig = {
  ...
  hero: {
    ...
    subtitle:
      "Politie, Koninklijke Marechaussee en Brandweer — routes, rollen en voorbereiding",
    imageSrc: "/img/eenheden/veiligheidsdiensten.jpg",
    imageAlt: "Veiligheidsdiensten",
  },
  intro: {
    emblemSrc: "/img/eenheden/veiligheidsdiensten-3.svg",
    emblemAlt: "Veiligheidsdiensten embleem",
    heading: "Wat zijn veiligheidsdiensten?",
    body:
      "Onder veiligheidsdiensten vallen functies waarbij je dagelijks werkt aan orde, veiligheid en hulpverlening — vaak onder druk, met duidelijke standaarden en stevige opleidingen. Deze pagina is er voor kandidaten die serieus willen instromen bij de Politie, de Koninklijke Marechaussee of de Brandweer.\n\nJe krijgt per onderdeel een helder overzicht van instroomroutes, rollen en doorgroeimogelijkheden — zodat je weet wat je kunt verwachten én waar je in je voorbereiding prioriteit aan moet geven: fysieke basis, belastbaarheid, herstel en mentale weerbaarheid.",
  },
  sections: [
    {
      title: "Politie",
  ...
  cta: {
    ...
    body:
      "We bespreken je doel, je startniveau en wat er nodig is voor jouw selectie of opleiding.",
    disclaimer:
      "Mission Movement is een onafhankelijke coachingdienst en niet verbonden aan Defensie, Politie of Brandweer.",
    buttonText: "Plan gratis intake",
    buttonLink: "/contact#contact-form",
  },
};

export default veiligheidsdienstenConfig;
